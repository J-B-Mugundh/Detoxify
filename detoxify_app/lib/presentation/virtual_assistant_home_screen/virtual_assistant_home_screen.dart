...
class VirtualAssistantHomeScreen extends StatelessWidget {
  VirtualAssistantHomeScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the medicalAssistantChatbotScreen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.medicalAssistantChatbotScreen);
  }
}
